                ...
                <div class="card panel panel-primary panel-colorful pad-all">
                    <div class="card-body row-flex align-items-center px-6 py-7">
                        ...
                        <div class="col-7 text-center">
                            <p class="fs-42 lh-12 mb-0 counterUp" data-count="{{ $records["doctor_count"] }}">0</p>
                            <p>Doctors</p>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                <div class="card panel panel-warning panel-colorful pad-all">
                    <div class="card-body row-flex align-items-center px-6 py-7">
                        ...
                        <div class="col-7 text-center">
                            <p class="fs-42 lh-12 mb-0 counterUp" data-count="{{ $records["patient_count"] }}">0</p>
                            <p>Patients</p>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                <div class="card panel panel-primary panel-colorful pad-all">
                    <div class="card-body row-flex align-items-center px-6 py-7">
                        ...
                        <div class="col-7 text-center">
                            <p class="fs-42 lh-12 mb-0 counterUp" data-count="{{ $records["appointment_count"] }}">0</p>
                            <p>Appointment</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="card panel panel-warning panel-colorful pad-all">
                    <div class="card-body row-flex align-items-center px-6 py-7">
                        ...
                        <div class="col-8 text-center">
                            <p class="fs-35 lh-10 mb-0 counterUp" data-count="555555523">0</p>
                            <p>Revenue</p>
                        </div>
                    </div>
                </div>
