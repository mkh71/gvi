...
<head>
    ...
    <meta name="author" content="BPAro">
    <title>BPAro Dashboard | @yield('title')</title>
    ...
    <link rel="stylesheet" href="{{ url('admin/plugins/morris-js/morris.min.css') }}">
            ...
            <div class="navbar-header">
                <a href="{{route('home')}}" class="navbar-brand">
                    ...
                    <div class="brand-title">
                        <span class="brand-text">BPAro <span class="text-warning text-bold"> Home</span> </span>
                    </div>
                </a>
            </div>
            <!--================================-->
...
{{--                    </li>--}}
                    ...
                    <li id="dropdown-user" class="dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right panel-default">
                            <ul class="head-list">
                                <li>
                                    <a href="{{route('profile', \Illuminate\Support\Facades\Auth::user()->info->id)}}"><i class="demo-pli-male icon-lg icon-fw"></i> Profile</a>
                                </li>
...
<!-- FOOTER -->
    ...
    <footer id="footer">
        <div class="hide-fixed pull-right pad-rgt">
            Developed By <strong>@BPAro</strong>.
        </div>
...
<script type="text/javascript" src="<?php echo asset('assets/js/tinymce.min.js') ?>"></script>

<script src="{{asset('js/timedropper-jquery.js')}}"></script>
