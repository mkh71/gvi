...
@section('top-title', "Brands")
@section('page-title', "Brands")
@section('panel-title', "Brands")
@section('content')
    <div class="row">
        <div class="col-lg-4 col-md-4 col-sm-12">
            {{ Form::open(['route'=>'brands.store', 'method'=>'post', 'files'=> true]) }}
                <div class="col-sm-12">
                    <h1 class="btn-primary btn btn-block text-center text-uppercase"> Add Brand </h1>
                    <br>
                </div>
        ...
        <div class="col-lg-8 col-md-8 col-sm-12">
            <div class="col-sm-12">
                <h1 class="btn-primary btn btn-block text-center text-uppercase"> View Brands </h1>
                <br>
            </div>
            <div class="col-sm-12">
                <table class="table table-responsive table-striped table-bordered datatable">
                    ...
                    <tr>
                        ...
                        <td>
                            <a class="btn btn-sm btn-info edit" title="Edit" href="{{ route('brands.edit',$info->id) }}">
